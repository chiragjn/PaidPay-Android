 ...
 */
public class ExpandingListViewPayVia extends ListView {
    ...
    public ExpandingListViewPayVia(Context context) {
        super(context);
        init();
    }

    public ExpandingListViewPayVia(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ExpandingListViewPayVia(Context context, AttributeSet attrs, int defStyle) {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView
        ...
        public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
        	...
        	{
	            ExpandableCardsWithOffers viewObject = (ExpandableCardsWithOffers)getItemAtPosition(getPositionForView
	                    (view));
    ...
    private void expandView(final View view) {
        final ExpandableCardsWithOffers viewObject = (ExpandableCardsWithOffers)getItemAtPosition(getPositionForView
                (view));
