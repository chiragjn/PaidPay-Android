 ...
 * its collapsed state.
 */
public class ExpandableCardsWithOffers implements OnSizeChangedListener {
	...
	public ExpandableCardsWithOffers(String card_name, int card_logo,
			int collaspedHeight, String balance, String type, String offer) {
